...
//For us this means D-/PB3, D+PB4
#define USB_CFG_DMINUS_BIT      PB3
/* This is the bit number in USB_CFG_IOPORT where the USB D- line is connected.
 * This may be any bit in the port.
 */
#define USB_CFG_DPLUS_BIT       PB4
/* This is the bit number in USB_CFG_IOPORT where the USB D+ line is connected.
 ...
 */
#define USB_CFG_VENDOR_NAME     'a', 't', '-', 'l', 'a', 'b', '.', 'n', 'l'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'C', 'r', 'y', 's', 't', 'a', 'l', 'b', 'o', 'i'
...
//* Stolen from DIGICDC, which is based on vusb
#define USB_INTR_CFG            PCMSK //Pin change mask register
#define USB_INTR_CFG_SET        (1<<USB_CFG_DPLUS_BIT) //So here we set where or D+ interrupt arrives
